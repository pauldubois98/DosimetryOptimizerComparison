...
\begin{document}
	...
	We observe that looking only at iterations, Newton's method looks like the very best, reaching within 10 steps a stable converged state in all 4 cases studied.
